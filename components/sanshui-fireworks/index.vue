<template>
	<canvas class="fire-canvas" :style="{width: '100vh', height: '100vw', 'z-index': zIndex}" :canvas-id="canvasId" @error="canvasIdErrorCallback"></canvas>
</template>
		...
		props: {
			...
			*/
			x: {
				type: [Number, String],
				default: () => {
					return systenInfo.windowHeight / 2
				}
			},
			/*
				中心点-y
			*/
			y: {
				type: [Number, String],
				default: () => {
					return systenInfo.windowWidth * 0.6
				}
			}
		},
		data() {
